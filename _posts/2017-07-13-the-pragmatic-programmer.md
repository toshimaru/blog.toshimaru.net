...
本書で紹介されているTipsとともにいくつか僕なりの説明・解説とともに紹介してみよう（Tipsは本書からの引用）。
...
これはとても興味深かった。これらを言い換えるならばコミュ力が必要ということ。きちんと物事を適切な方法で伝えること。
...
1. リファクタリングと昨日の追加を同時にやらない
2. リファクタリングを始める前にしっかりテストを用意
3. 各作業は小さな単位にまとめ、慎重にすすめること
